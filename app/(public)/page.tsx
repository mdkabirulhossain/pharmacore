    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="py-32 bg-[#f4f4f4] text-center border-t border-gray-200">
           <h2 className="text-3xl font-bold mb-8">Ready to modernize your pharmacy?</h2>
           <div className="flex justify-center gap-4 mb-6">
              <button className="bg-black text-white px-8 py-4 rounded-md font-bold text-sm">Get Started Free</button>
              <button className="bg-white border border-gray-200 px-8 py-4 rounded-md font-bold text-sm">Schedule a Demo</button>
           </div>
