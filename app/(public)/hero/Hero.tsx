...
export const Hero = () => (
  <section className="pt-20 pb-12 px-4 text-center bg-[#f4f4f4]">
    ...
    <div className="flex flex-wrap justify-center gap-4 mb-24">
      ...
      <button className="bg-white border border-gray-200 px-8 py-4 rounded-md font-bold text-sm">Book a Demo</button>
    </div>
